...
DOMAIN=rosdiyanto.my.id
SUB_DOMAIN=onichan-${sub}.rosdiyanto.my.id
NS_DOMAIN=zerosl-${sub}.rosdiyanto.my.id
CF_ID=rosdiyantodede@gmail.com
CF_KEY=d123a4ff290f12c6a5d82b179503828cef55c
set -euo pipefail
